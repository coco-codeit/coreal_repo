    ...
    <div className="w-[250px]">
      ...
      <CustomDayPicker
        ...
        classNames={{
          ...
          selected:
            "w-[35.71px] h-[32px] bg-orange-600 text-white rounded-lg flex items-center justify-center",
          ...
          nav: "hidden",
          nav_button:
            "w-6 h-6 flex items-center justify-center bg-orange-600 text-white rounded-full",
        }}
        modifiersClassNames={{
